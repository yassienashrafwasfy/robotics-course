...
class DRLEnvironment(Node):
    ...
    *******************************************************************************"""
    ...
    def odom_callback(self, msg):
        ...
        self.current_distance = math.sqrt(diff_x**2 + diff_y**2)
    ...
    def step_comm_callback(self, request, response):
        ...
        self.distance_moved = self.past_distance - self.current_distance
        # print(self.past_distance ,self.current_distance)
        ...
        # Prepare repsonse
        # print("Distance moved :",  self.distance_moved*100)
