...
inline void to_yaml(
  const turtlebot3_msgs::srv::RingGoal_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const turtlebot3_msgs::srv::RingGoal_Request & msg)
{
...
[[deprecated("use turtlebot3_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlebot3_msgs::srv::RingGoal_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlebot3_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlebot3_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const turtlebot3_msgs::srv::RingGoal_Response & msg)
{
  return turtlebot3_msgs::srv::to_yaml(msg);
}
