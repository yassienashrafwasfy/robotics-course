  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlebot3_msgs__srv__RingGoal_Request;
    is_plain =
      (
...
static size_t _RingGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtlebot3_msgs__srv__RingGoal_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtlebot3_msgs__srv__RingGoal_Response;
    is_plain =
      (
...
static size_t _RingGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtlebot3_msgs__srv__RingGoal_Response(
    full_bounded, is_plain, 0);
