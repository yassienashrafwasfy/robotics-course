...
static rosidl_typesupport_introspection_c__MessageMember turtlebot3_msgs__srv__Goal_Request__rosidl_typesupport_introspection_c__Goal_Request_message_member_array[1] = {
  {
    ...
    offsetof(turtlebot3_msgs__srv__Goal_Request, empty),  // bytes offset in struct
    NULL,  // default value
...
static rosidl_typesupport_introspection_c__MessageMember turtlebot3_msgs__srv__Goal_Response__rosidl_typesupport_introspection_c__Goal_Response_message_member_array[1] = {
  {
    "new_goal",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_BOOLEAN,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlebot3_msgs__srv__Goal_Response, new_goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
