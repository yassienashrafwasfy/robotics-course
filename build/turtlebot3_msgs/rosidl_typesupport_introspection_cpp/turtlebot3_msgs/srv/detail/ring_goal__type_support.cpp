...
{
  new (message_memory) turtlebot3_msgs::srv::RingGoal_Request(_init);
}

void RingGoal_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtlebot3_msgs::srv::RingGoal_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RingGoal_Request_message_member_array[3] = {
  {
    ...
    offsetof(turtlebot3_msgs::srv::RingGoal_Request, robot_pose_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlebot3_msgs::srv::RingGoal_Request, robot_pose_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlebot3_msgs::srv::RingGoal_Request, radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RingGoal_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(turtlebot3_msgs::srv::RingGoal_Request),
...
{
  return &::turtlebot3_msgs::srv::rosidl_typesupport_introspection_cpp::RingGoal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_msgs, srv, RingGoal_Request)() {
  return &::turtlebot3_msgs::srv::rosidl_typesupport_introspection_cpp::RingGoal_Request_message_type_support_handle;
}
...
void RingGoal_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) turtlebot3_msgs::srv::RingGoal_Response(_init);
}

void RingGoal_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtlebot3_msgs::srv::RingGoal_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RingGoal_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlebot3_msgs::srv::RingGoal_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RingGoal_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(turtlebot3_msgs::srv::RingGoal_Response),
...
{
  return &::turtlebot3_msgs::srv::rosidl_typesupport_introspection_cpp::RingGoal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_msgs, srv, RingGoal_Response)() {
  return &::turtlebot3_msgs::srv::rosidl_typesupport_introspection_cpp::RingGoal_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers RingGoal_service_members = {
  ...
  // see get_service_type_support_handle<turtlebot3_msgs::srv::RingGoal>()
...
get_service_type_support_handle<turtlebot3_msgs::srv::RingGoal>()
{
  ...
  auto service_type_support =
    &::turtlebot3_msgs::srv::rosidl_typesupport_introspection_cpp::RingGoal_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_msgs, srv, RingGoal)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<turtlebot3_msgs::srv::RingGoal>();
}
