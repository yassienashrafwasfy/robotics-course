...
void fetch_function__DrlStep_Request__action(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__DrlStep_Request__action(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__DrlStep_Request__action(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__DrlStep_Request__action(untyped_member, index));
...
void fetch_function__DrlStep_Request__previous_action(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__DrlStep_Request__previous_action(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__DrlStep_Request__previous_action(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__DrlStep_Request__previous_action(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DrlStep_Request_message_member_array[2] = {
  {
    ...
    fetch_function__DrlStep_Request__action,  // fetch(index, &value) function pointer
    assign_function__DrlStep_Request__action,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__DrlStep_Request__previous_action,  // fetch(index, &value) function pointer
    assign_function__DrlStep_Request__previous_action,  // assign(index, value) function pointer
...
void fetch_function__DrlStep_Response__state(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__DrlStep_Response__state(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__DrlStep_Response__state(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__DrlStep_Response__state(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DrlStep_Response_message_member_array[5] = {
  {
    ...
    fetch_function__DrlStep_Response__state,  // fetch(index, &value) function pointer
    assign_function__DrlStep_Response__state,  // assign(index, value) function pointer
